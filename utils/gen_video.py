...
def parse_args():
    ...
    parser.add_argument("--cfg", default="/data2/lane_data/LaneATT/experiments/laneatt_r18_tusimple/config.yaml", help="Config file")
    ...
    parser.add_argument("--legend", default="/data2/lane_data/LaneATT/_datasets/tusimple-test/clips/0601/1494452577507766671/", help="Path to legend image file")
